...
printf "\n"
sleep 1
curl -X DELETE -H "Authorization: token $githubToken" https://api.github.com/repos/"$gituser"/"$gitrepo.$rootdomain"&> /dev/null
...
printf "Done\n"
printf "++++++++++++++++++\n"
printf "git clone https://$gituser:$gitpass@github.com/$gituser/$gitrepo.$rootdomain.git /home/$gitrepo/www\n">> /root/uploadlists.txt
